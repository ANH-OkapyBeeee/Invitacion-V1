              ...
              <div className="flex justify-center mb-4">
                <div className="relative">
                  ...
                  <a 
                    ...
                    className="absolute -bottom-3 -right-3 w-9 h-9 rounded-full bg-white flex items-center justify-center shadow-[0_4px_15px_rgba(0,0,0,0.3)] hover:scale-110 active:scale-95 transition-all duration-300 border border-gray-100 z-20 animate-pulse cursor-pointer"
